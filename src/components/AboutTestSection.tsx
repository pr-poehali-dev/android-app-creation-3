      ...
      <Card className="p-6 sm:p-8 bg-white shadow-lg">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Комплексная психологическая диагностика с элементами нейропсихологической диагностики</p>
          </div>
        </div>
        ...
        <div className="space-y-6 text-gray-700">
          ...
          <section className="bg-gradient-to-br from-purple-50 to-blue-50 p-6 rounded-lg border-2 border-purple-200">
            <h3 className="text-xl font-semibold text-gray-900 mb-3 flex items-center gap-2">
              ...
              Что включает комплексная психологическая диагностика?
            </h3>
            <p className="leading-relaxed mb-4">
              Этот тест — не просто опросник. Это комплексная психологическая диагностика с элементами нейропсихологической диагностики, 
              включающая 5 научно обоснованных блоков. Она позволяет получить полную картину вашего психологического состояния: 
              от эмоций и настроения до когнитивных функций и состояния нервной системы.
            </p>
