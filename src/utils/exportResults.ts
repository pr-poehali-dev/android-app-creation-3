...
export const generateResultsText = (depressionScore: number, stressScore: number, anxietyScore: number, burnoutScore = 0, neuroScore = 0): string => {
  ...
  if (burnoutScore <= 6) {
    text += `✅ Эмоциональное выгорание: У вас хороший энергетический баланс! Вы умеете восстанавливаться и находить смысл в том, что делаете. Продолжайте в том же духе!\n\n`;
  } else if (burnoutScore <= 12) {
    text += `💛 Эмоциональное выгорание: Вы начинаете терять запал — усталость накапливается, энтузиазма становится меньше. Важно остановиться и восстановить ресурсы. Я помогу вам найти баланс и вернуть вдохновение.\n\n`;
  } else if (burnoutScore <= 18) {
    text += `🧡 Эмоциональное выгорание: Силы на исходе — всё кажется бессмысленным, работа не приносит удовлетворения, постоянная апатия. Это серьёзный сигнал. Вместе мы восстановим ваши внутренние ресурсы и найдем новые смыслы.\n\n`;
  } else {
    text += `❤️ Эмоциональное выгорание: Полное истощение — эмоциональное, физическое и психологическое. Вы отдавали себя без остатка, и теперь резервы на нуле. Профессиональная помощь необходима. Я помогу вам восстановиться и научиться беречь себя.\n\n`;
  }

  if (neuroScore <= 6) {
    text += `✅ Нейродиагностическое заключение: Когнитивные функции в норме — концентрация, память и мышление работают хорошо. Ваш мозг функционирует эффективно!\n\n`;
  } else if (neuroScore <= 12) {
    text += `💛 Нейродиагностическое заключение: Есть лёгкие когнитивные затруднения — сложнее сосредоточиться, замечаете забывчивость или «туман в голове». Это часто связано со стрессом и усталостью. Я помогу разобраться в причинах и улучшить ясность мышления.\n\n`;
  } else if (neuroScore <= 18) {
    text += `🧡 Нейродиагностическое заключение: Выраженные когнитивные нарушения — трудно концентрироваться, память подводит, решения даются с трудом. Это влияет на качество жизни и работы. Профессиональная диагностика и работа с психологом помогут восстановить когнитивный ресурс.\n\n`;
  } else {
    text += `❤️ Нейродиагностическое заключение: Серьёзные когнитивные нарушения — значительное снижение концентрации, памяти и способности принимать решения. Необходима срочная профессиональная поддержка. Я помогу провести более детальную диагностику и составить план восстановления.\n\n`;
  }
